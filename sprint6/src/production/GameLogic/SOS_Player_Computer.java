...
public class SOS_Player_Computer extends SOS_Player_Main {
	...
	private void conjureMove() {
		...
		// making sure Computer cannot choose cells that are already occupied
		while(gameStateManager.getRemainingCells() < numberOfUtilsToCompare) {
			numberOfUtilsToCompare--;
		}
		...
		// now check which between SO the computer plays
