...
public class MenuBarManager {
	...
	private void buildEditMenu() {
		...
		displayUtilMenuItem = new JCheckBoxMenuItem("Display Utilities");

		// set the events for when the buttons are pressed
		undoButtonItem.addActionListener(e -> undoPressed());
		redoButtonItem.addActionListener(e -> redoPressed());
		displayUtilMenuItem.addActionListener(e -> toggleDisplayUtils());

		// add buttons to the dropdown menu
		EditMenu.add(undoButtonItem);
		EditMenu.add(redoButtonItem);
		EditMenu.add(displayUtilMenuItem);
	...
	private void loadGamePressed() {
		window.loadGamePressed();
	}

	private void saveGamePressed() {
		window.saveGamePressed();
	}
	...
	private void toggleDisplayUtils() {
		window.toggleDisplayUtils();
	}
	...
	public GameType getSelectedGameType() {
		return (simpleGameItem.isSelected() ? GameType.Simple : GameType.General);
	}
